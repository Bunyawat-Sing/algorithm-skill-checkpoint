...
Answer: O(n) because use linear search
...
Answer: O(2n) because use binary search
...
Answer: findProductPrice because have Big O = O(n) that have shorter time to compile compare to findProductPrice (O(2n))
